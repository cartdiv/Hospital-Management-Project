<?php 
  ...
  $sql = "SELECT bed_booking.id,hospital.name as hname,bed_booking.type FROM bed_booking,hospital WHERE hospital.id = bed_booking.hid and bed_booking.pid = '$id' and bed_booking.status = 1";
                            ...
                            <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="bed_cancel.php?del=<?php echo $row['id']; ?>" class="btn btn-danger">Cancel</a></td>
                                    </tr>
                                  <?php } ?>  
                                </tbody>
