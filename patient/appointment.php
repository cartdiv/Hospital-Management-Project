<?php 
  ...
  $sql = "SELECT appointment.id,doctor.name as dname FROM doctor,appointment WHERE doctor.id = appointment.did and appointment.pid = '$id' and appointment.status = 1";
                            ...
                            <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="app_del.php?del=<?php echo $row['id']; ?>" class="btn btn-danger">Cancel</a></td>
                                    </tr>
                                  <?php } ?>  
                                </tbody>
