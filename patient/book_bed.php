...
<?php 
  ...
  if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `bed_booking`(`pid`,`hid`,`type`,`status`) VALUES('$pid','$hid','$bed_type',0)";
                ...
                <li>
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Book Bed</a></li>
                                ...
                                <form action="" method="post">
                                    <div class="form-row mb-4">
                                        ...
                                        <select class="form-control" name="route">
                                            ...
                                            <?php 
                                              $rsql="select id,name from `hospital` order by `id` desc";
                                        ...
                                        <div class="col">
                                            <select class="form-control" name="bed">
                                                ...
                                                <option value="Critical Care">Critical Care Bed</option>
                                                <option value="Long-term Care">Long-term Care Bed</option>
                                                <option value="Specialty Hospital">Specialty Hospital Bed</option>
                                            </select>
                                        </div>
                                        <div class="col">
