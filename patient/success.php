                                ...
                                <div class="widget-header">                                
                                    <div class="row">
                                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                            <h4>Hello <?php echo $_SESSION['name'] ?> your appointment as been Successfully booked</h4>
                                            <h4>You can check your booking</h4> <button value="Booking" class="mb-4 btn btn-primary"><a href="appointment.php">booking</a> </button>
                                        </div>
                                    </div>
                                </div>
