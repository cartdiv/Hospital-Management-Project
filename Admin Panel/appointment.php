<?php 
  ...
  $sql="SELECT appointment.id,doctor.name as dname,patient.name as pname, appointment.status FROM doctor,appointment,patient WHERE doctor.id = appointment.did and patient.id = appointment.pid";
                ...
                <li>
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Check Appointment</a></li>
